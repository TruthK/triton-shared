...
#include "triton-shared/Codegen/Dialect/VectorExt/IR/VectorExtDialect.cpp.inc"

using namespace mlir::tts::IREE::VectorExt;

#include "triton-shared/Codegen/Dialect/VectorExt/IR/VectorExtAttrInterfaces.cpp.inc"
...
#define GET_OP_LIST
  addOperations<
#include "triton-shared/Codegen/Dialect/VectorExt/IR/VectorExtOps.cpp.inc"
      >();
}

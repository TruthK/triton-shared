...
static bool isDestinationFullyOverwritten(vector::TransferWriteOp writeOp) {
  ...
  if (vecType.isScalable()) {
    auto targetAttr =
        tts::IREE::GPU::ExecutableTargetAttr::lookup(writeOp);
    vscaleRange = tts::getDefaultVscaleRange(targetAttr);
  }
...
void mlir::tts::populateVectorTransferTensorSliceTransforms(
